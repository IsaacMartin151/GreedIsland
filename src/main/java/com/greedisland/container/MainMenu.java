...
public class MainMenu extends Screen {
    ...
    public MainMenu() {
        ...
        GreedIsland.LOGGER.info("Trying to get departure at: " + Minecraft.getInstance().getResourcePackDirectory().toAbsolutePath());
        File departure = new File(Minecraft.getInstance().getResourcePackDirectory().toAbsolutePath()+"/departure.mp4");
...
//        for (Button renderable : this.renderables) {
