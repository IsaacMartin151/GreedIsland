...
import com.levelhearts.SyncHealthPacket;
...
public class PacketManager {
    ...
    public static final SimpleChannel INSTANCE = NetworkRegistry.newSimpleChannel(new ResourceLocation(GreedIsland.MODID, "packetmanager"), () -> PROTOCOL_VERSION, PROTOCOL_VERSION::equals, PROTOCOL_VERSION::equals);
